...
final class SQLiteTests: XCTestCase {
    ...
    // Note: access to Downloads folder should be enabled for Xcode in Settings->Security & Privacy
    static let testDBPath = try! (FileManager.default.url(for: .downloadsDirectory, in: .userDomainMask, appropriateFor: nil, create: false).appendingPathComponent("testDB.sqlite")).path
